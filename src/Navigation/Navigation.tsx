...
import FriendList from '../Screens/message/friendList';
...
const Navigation = () => {
  ...
  return <NavigationContainer>
    <Stack.Navigator initialRouteName='SplashScreen' >
      ...
      {/* message */}
      <Stack.Screen name="Message" component={MessageMain} options={({ navigation }) => ({
        title: "Messages", headerBackVisible: false, headerRight: () => (
          <Icon
